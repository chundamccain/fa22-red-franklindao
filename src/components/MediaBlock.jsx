    ...
    <>
      <div className="flex flex-col items-center mt-12 mb-20 ml-3 mr-3">
        <div className="flex flex-col w-72 py-6 px-6 rounded-3xl border-4 border-purple">
          <div className = "object-cover border-blue rounded-lg" alt = "">
            <a href={link}><img className="border-blue rounded-lg" width="280" height="auto" src={image} alt="PBC Shorts" border="0"/></a>
          ...
          <a href={link}><button className="mt-8 py-2 text-lg border-4 border-purple text-purple underline rounded-full">
            {name}
          </button> 
          </a>
        </div>
